...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@wraithwalker/core/project-config": fileURLToPath(new URL("../core/src/project-config.mts", import.meta.url)),
      ...
      "@wraithwalker/core/site-config": fileURLToPath(new URL("../core/src/site-config.mts", import.meta.url)),
