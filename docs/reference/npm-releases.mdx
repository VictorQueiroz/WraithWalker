---
title: Package and Extension Releases
description: Understand workspace-scoped versioning, Changesets, and release automation.
---
...
- The root [`package.json`](https://github.com/VictorQueiroz/WraithWalker/blob/main/package.json) is private workspace metadata and is **not** the release source of truth.
