---
title: Guided Scenario Traces
description: Record click-driven traces that connect user interactions to captured fixtures.
---
...
- [Extension workflow](/docs/workflows/extension-workflow)
- [MCP client setup](/docs/workflows/mcp-clients)
- [MCP server README](/docs/packages/mcp-server)
