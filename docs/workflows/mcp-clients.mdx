...
description: Connect Codex, Cursor, Windsurf, Claude Code, and other MCP clients to WraithWalker.
---
...
More: [Guided scenario traces](/docs/workflows/guided-scenario-traces)
...
- For `stdio` mode, keep using the command-based config shown in [packages/mcp-server/README.md](/docs/packages/mcp-server).
